...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        ...
        return Result.error(ResultCodeEnum.BAD_REQUEST.getCode(), "缺少请求参数: " + e.getParameterName());
    }
    ...
    public Result<Void> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        return Result.error(ResultCodeEnum.METHOD_NOT_ALLOWED);
    }
    ...
    public Result<Void> handleException(Exception e) {
        log.error("系统异常", e);
        return Result.error(ResultCodeEnum.INTERNAL_SERVER_ERROR.getCode(), "系统繁忙，请稍后重试");
    }
}
